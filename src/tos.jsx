export default function Tos() {
  return (
    <div>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Club App.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Club App, accessible from{" "}
            <a
              href="https://club-app-six.vercel.app/"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://club-app-six.vercel.app/
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: david@btreecode.com</li>
      </ul>
    </div>
  );
}
